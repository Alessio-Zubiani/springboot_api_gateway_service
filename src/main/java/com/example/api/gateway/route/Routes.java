...
public class Routes {
	...
	public RouterFunction<ServerResponse> orderServiceSwaggerRoute() {
		...
		return GatewayRouterFunctions.route("order_service_swagger")
				.route(RequestPredicates.path("/aggregate/order-service/swagger-ui.html"), HandlerFunctions.http("http://localhost:8081"))
				.filter(setPath("swagger-ui.html"))
				.build();
	}
	...
	public RouterFunction<ServerResponse> inventoryServiceSwaggerRoute() {
		...
		return GatewayRouterFunctions.route("inventory_service_swagger")
				.route(RequestPredicates.path("/aggregate/inventory-service/swagger-ui.html"), HandlerFunctions.http("http://localhost:8082"))
				.filter(setPath("swagger-ui.html"))
				.build();
	}
