...
public class Routes {
	...
	public RouterFunction<ServerResponse> productServiceSwaggerRoute() {
		...
		return GatewayRouterFunctions.route("product_service_swagger")
				.route(RequestPredicates.path("/product-service/swagger-ui.html"), HandlerFunctions.http("http://localhost:8080"))
	...
	public RouterFunction<ServerResponse> orderServiceSwaggerRoute() {
		...
		return GatewayRouterFunctions.route("order_service_swagger")
				.route(RequestPredicates.path("/order-service/swagger-ui.html"), HandlerFunctions.http("http://localhost:8081"))
	...
	public RouterFunction<ServerResponse> inventoryServiceSwaggerRoute() {
		...
		return GatewayRouterFunctions.route("inventory_service_swagger")
				.route(RequestPredicates.path("/inventory-service/swagger-ui.html"), HandlerFunctions.http("http://localhost:8082"))
